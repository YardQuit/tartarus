...
##                          "TARTARUS Atomic" / tartarus-atomic
...
os_release_set VARIANT           "\"TARTARUS Atomic\""
os_release_set VARIANT_ID        "tartarus-atomic"
os_release_set VERSION           "\"${OS_BUILD} (TARTARUS Atomic)\""
os_release_set PRETTY_NAME       "\"${OS_NAME} ${OS_BUILD} (TARTARUS Atomic)\""
os_release_set DEFAULT_HOSTNAME  "\"tartarus\""
os_release_set HOME_URL          "\"https://github.com/yardquit/tartarus\""
os_release_set DOCUMENTATION_URL "\"https://github.com/yardquit/tartarus\""
os_release_set SUPPORT_URL       "\"https://github.com/yardquit/tartarus/issues\""
os_release_set BUG_REPORT_URL    "\"https://github.com/yardquit/tartarus/issues\""
os_release_set IMAGE_ID          "tartarus"
...
( . "${OS_RELEASE}"
  [ "${VARIANT_ID:-}" = "tartarus-atomic" ] || { echo "os-release: VARIANT_ID not applied" >&2; exit 1; }
  [ "${IMAGE_ID:-}" = "tartarus" ]          || { echo "os-release: IMAGE_ID not applied" >&2; exit 1; }
  case "${PRETTY_NAME:-}" in
      *"TARTARUS Atomic"*) ;;
...
POLICY_SCOPE="${IMAGE_REPO:-ghcr.io/yardquit/tartarus}"
